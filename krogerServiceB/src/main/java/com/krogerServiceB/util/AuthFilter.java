...
import com.krogerServiceB.exception.ExceptionDetails;
...
public class AuthFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		if (userToken != null && userToken.startsWith("Bearer ")) {
			...
			try {
				...
				ExceptionDetails errorResponse = new ExceptionDetails("Invalid Token, Token Not Recognised",false);
	...
	public String convertObjectToJson(ExceptionDetails object) throws JsonProcessingException {
		if (object == null) {
			return null;
		}
