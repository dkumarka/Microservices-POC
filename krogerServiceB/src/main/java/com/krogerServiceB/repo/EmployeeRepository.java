...
public interface EmployeeRepository extends JpaRepository<Employee, Integer> {
    ...
    Employee getEmployeeByIdWithoutStatus(int id);

	@Query("SELECT emp FROM Employee emp WHERE emp.id in(:employeeId) and emp.status='Active'")
	List<Employee> getEmployeeByIds(List<Integer> employeeId);
